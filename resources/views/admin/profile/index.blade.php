            ...
            <div>
                ...
                <div class="mt-6 p-6 bg-white rounded-md shadow-md">
                    ...
                    <form class="mt-4" action="{{ route('user-password.update') }}" method="POST">
                        ...
                        <div>
                            <label class="block">
                                <span class="text-gray-700 text-sm">Old Password</span>
                                <input type="password" name="current_password"
                                    class="form-input mt-1 block w-full rounded-md" placeholder="Old Password">
                            </label>
                        </div>
                        <div class="mt-4">
                            <label class="block">
                        ...
                        <div class="mt-4">
                            <label class="block">
                                ...
                                <input type="password" name="password_confirmation"
                                    ...
                                    placeholder="Confirm New Password Baru">
                            </label>
                        </div>
                        <div class="flex justify-start mt-4">
                            <button type="submit"
