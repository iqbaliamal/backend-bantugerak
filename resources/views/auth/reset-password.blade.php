        ...
        <div class="flex flex-col overflow-y-auto md:flex-row">
            ...
            <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                <div class="w-full">
                    ...
                    @if (session('status'))
                    <div class="bg-green-300 p-3 rounded-md shadow-sm text-sm mt-3 mb-3">
                        <p class="text-gray-800 text-sm">{{ session('status') }} </p>
                    </div>
                    @endif
                    <form class="mt-4" action="{{ route('password.update') }}" method="POST">
                        ...
                        <label class="block text-sm">
                            ...
                            @error('email')
                            <div
                                class="inline-flex max-w-sm w-full bg-red-300 shadow-sm rounded-md overflow-hidden mt-2">
                                <div class="px-4 py-2">
                        ...
                        <label class="block mt-4 text-sm">
                            ...
                            @error('password')
                            <div class="inline-flex max-w-sm w-full bg-red-300 shadow-sm rounded-md overflow-hidden mt-2">
                                <div class="px-4 py-2">
                                    <p class="text-gray-600 text-sm">{{ $message }}</p>
                                </div>
                            </div>
